...
INSERT INTO products.keywords_types(keyTypeID, keyTypeName)
VALUES(1,'Culture'),
      (2,'Diet'),
      (3,'Taste');

INSERT INTO products.keywords_defs(keyID, keyName, keyDesc, keyTypeID)
...
INSERT INTO products.categories_defs(catID, catName, catDesc, catAvail)
...
INSERT INTO products.categories_subcats(subcatID,subcatName, fkCatID)
...
INSERT INTO products.options_defaults(optDefaultsID, defaultValue)
VALUES (1,'Selected'),
       (2,'None');

INSERT INTO products.options_types(optTypesID, optTypeValue)
VALUES (1,'Checkbox'),
       (2,'Radio'),
       (3,'Text');
